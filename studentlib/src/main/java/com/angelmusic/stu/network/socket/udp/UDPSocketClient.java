...
public class UDPSocketClient implements Runnable {
    ...
    public UDPSocketClient(String host, int port, AbsReceiver receiver) {
    ...
    public void run() {
        try {
            mSocket = new UDPSocket(receiver);
    ...
    private static class SendThread extends Thread {
        ...
        private SendThread(UDPSocket socket) {
            this.mSocket = socket;
            this.start();
        }
...
//            }
//        }.start();
//        UDPSocketClient client = new UDPSocketClient("127.0.0.1", 9999, new AbsReceiver() {
//            @Override
